...
void logic(iPPXY, int height, int width, int &dir, int &last, int &score, bool &endGame, bool &endMap, bool &confirm, int obj[27], int randomObj, char idxObj[][widthB+2],int idxNum[][widthB+2], int line[][widthB+2], int lineOut[][widthB+3], int lineEnd[][widthB+2], int lineHelp[][widthB+2], int resetNum[][widthB+2], int resetLine[][widthB+2], int resetLineOut[][widthB+3], int resetLineEnd[][widthB+2], int greenBlock[][widthB+2], int redBlock[][widthB+2])
{
    switch(dir)
	{
		case 1:
...
void resetBackground(string backgroundGame[])
{
    for(int i = 0; i < 5; i++)
        for(int j = 0; j < widthB + 2; j++)
            backgroundGame[i][j] = ' ';
